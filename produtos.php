...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container produtos-container">
      <div class="row">
        <?php for($c=0; $c<6; $c++){ ?>
        <div class="default-service-column col-4">
          <div class="inner-box">
              <div class="inner-most">
                <figure class="image-box">
                  <img width="370" height="270" src="https://www.eaemaquinas.com.br/wp-content/uploads/sites/4/2017/12/trator-new-holland-premio-do-ano.jpg" class="img-responsive wp-post-image" alt="featured-image-1">
                </figure>
                <div class="lower-part">
                    ...
                    <div class="content">
                      ...
                      <div class="more-link"><a href="single-produtos.php" class="read-more">Clique aqui</a></div>
                    </div>
                </div>
              </div>
          </div>
