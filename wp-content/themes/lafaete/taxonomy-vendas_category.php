  ...
  <body>
    ...
    <div class="container produtos-container menu-imoveis">
        <ul class="nav justify-content-center">
          ...
          ?>
          <li class="nav-item">
            <a class="nav-link" href="#<?php echo $categoria->slug; ?>"><?php echo $categoria->name; ?></a>
          </li>
          <?php endforeach; ?>
        ...
        <div class="row">
          ...
          <div class="default-service-column col-md-4 imagemGaleria <?php foreach( $tipos as $tipo ) : echo $tipo->slug; endforeach; ?>">
            <div class="inner-box">
