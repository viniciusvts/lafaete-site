<div class="container-fluid fixed-top topo-menu fixed-top" id="menu-topo">
  <div class="row d-flex align-items-center">
    ...
    <div id="social-icons" class="col-lg-3 col-md-4 col-sm-4 col-12">
      <div class="social d-flex align-items-center">
          <a href="https://www.facebook.com/lafaetelocacao/" target="_blank" class="mr-auto ml-auto"><i class="fa fa-facebook"></i></a>
          <a href="https://www.instagram.com/lafaetelocacao/" target="_blank" class="mr-auto ml-auto"><i class="fa fa-instagram"></i></a>
          <a href="https://www.linkedin.com/company/lafaetelocacao/" target="_blank" class="mr-auto ml-auto"><i class="fa fa-linkedin"></i></a>
      </div>
    </div>
...
<nav class="navbar navbar-expand-xl navbar-dark bg-dark fixed-top menu-container" id="menu-principal">
  <a class="navbar-brand" href="<?php bloginfo('url'); ?>">
    <!-- <img src="<?php //echo( get_theme_mod( 'dnaTheme_setting_logo') ); ?>" width="170px"> -->
    <img src="<?php echo get_template_directory_uri(); ?>/inc/img/update/logo-lafaete.svg" alt="">
  </a>
