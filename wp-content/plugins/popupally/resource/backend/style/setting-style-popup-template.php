		...
		<div id="template-customization-section-{{id}}">
			...
			<div class="template-customization-block popupally-setting-section" id="template-customization-block-{{id}}-sample-simple-choice">
				<div class="popupally-setting-configure-block">
					...
					<a class="popupally-trial-button" href="https://accessally.com/popupally-free-link/" target="_blank"><span class="popupally-click-arrow"></span>Try PopupAlly Pro for $1!</a>
				</div>
				<a class="popupally-sample-template-image" href="https://accessally.com/popupally-free-link/" target="_blank">
