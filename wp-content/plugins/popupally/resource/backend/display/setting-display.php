...
if (!class_exists('PopupAllyDisplaySettings')) {
	class PopupAllyDisplaySettings {
		...
		public static function show_display_settings() {
			...
			echo '<div class="popupally-setting-section"><div class="popupally-setting-section-header">Want more popups? <a class="popupally-trial-link" href="https://accessally.com/popupally-free-link/" target="_blank">Get PopupAlly Pro now!</a></div></div></div>';
		}
