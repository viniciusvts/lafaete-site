...
<nav class="navbar navbar-expand-xl navbar-light bg-light fixed-top menu-container" id="menu-principal">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item">
        <a class="nav-link" href="seminovos.php">Seminovos</a>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="servicos.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Serviços
        </a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="fale-conosco.php">Contato</a>
          <a class="dropdown-item" href="trabalhe-conosco.php">Trabalhe Conosco</a>
          <a class="dropdown-item" href="abertura-de-chamado.php">Abertura de Chamado</a>
        </div>
      </li>
      <li class="nav-item">
